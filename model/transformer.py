# -*- coding: utf-8 -*-
# AUTHOR: Xingsheng Zhang
# DATE: 3-5-20

# Code Referenc e: http://nlp.seas.harvard.edu/2019/04/03/attention.html
...
class Encoder(nn.Module):
    """"Core encoder is a stack of N my_layers"""
...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask=None):
        ...
        # print('s-query:{}'.format(query.size()))
        # print('s-key:{}'.format(key.size()))
        # print('s-value:{}'.format(value.size()))
